...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Redirection vers la page de connexion après le traitement
    header('Location: index.php?page=connexionView');
    exit(); // Assurez-vous de quitter le script après la redirection
}

// Placez ci-dessous la logique qui n'a pas besoin d'être exécutée avant la soumission du formulaire
